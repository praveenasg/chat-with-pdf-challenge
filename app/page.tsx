...
const features = [
  ...
  },
  {
    name: "Cloud Backup",
    description:
      " Rest assured knowing your documents are safely backed up on the cloud, proteted from loss or damage.",
    icon: ServerCogIcon,
  },
  {
    name: "Responsive Across Devices",
    description:
      "Access and chat with your PDRs seamlessly on any device, whether it's your desktop, phone, tablet, or smartphone.",
...
export default function Home() {
  return (
    <main className="flex-1 overflow-scroll p-2  bg-gradient-to-bl from-white to-indigo-600">
